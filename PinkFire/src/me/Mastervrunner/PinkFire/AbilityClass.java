package me.Mastervrunner.PinkFire;
...
public class AbilityClass extends FireAbility implements AddonAbility {
	...
	public void progress() {
		...
		double Radius = 5;
		double effectRadius = 4;
		Location loc = location;
		   
		for (double y = effectRadius; y >= 0; y -= 0.007) {
        	Radius = y / 3;
            ...
            player.getWorld().spawnParticle(Particle.REDSTONE, loc2.getX(), loc2.getY(), loc2.getZ(), 0, 0.001, 0, 0, 0, new Particle.DustOptions(Color.FUCHSIA, 1));
        ...
        for (double y = effectRadius; y >= 0; y -= 0.007) {
            ...
            Location loc2 = new Location(loc.getWorld(), loc.getX() + x, loc.getY() + y2, loc.getZ() + z);
            player.getWorld().spawnParticle(Particle.REDSTONE, loc2.getX(), loc2.getY(), loc2.getZ(), 0, 0.001, 0, 0, 0, new Particle.DustOptions(Color.PURPLE, 1));
        }
	...
	public void load() {
		...
		ProjectKorra.plugin.getServer().getPluginManager().registerEvents(new AbilityClassListener(), ProjectKorra.plugin);
